...
<div x-data="{show : true}" x-show="show" x-init="setTimeout(() => show = false, 5000)"  class="bg-gray-900 fixed m-2 bottom-0 left z-50 0 border-t-4 border-gray-500 rounded-b text-gray-100 px-4 py-3 shadow-md" role="alert">
  <div class="flex">
